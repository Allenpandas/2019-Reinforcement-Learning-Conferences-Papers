...
- [AAAI Conference on Artificial Intelligence (AAAI'2019)](#AAAI-Conference-on-Artificial-Intelligence)
- [International Conference on Autonomous Agents and Multiagent Systems (AAMAS'2019)](#International-Conference-on-Autonomous-Agents-and-Multiagent-Systems)
- [International Conference on Learning Representations (ICLR'2019)](#International-Conference-on-Learning-Representations)
- [International Conference on Machine Learning (ICML'2019)](#International-Conference-on-Machine-Learning)
- [International Conference on Robotics and Automation (ICRA'2019)](#International-Conference-on-Robotics-and-Automation)
- [International Joint Conference on Artificial Intelligence (IJCAI'2019)](#International-Joint-Conference-on-Artificial-Intelligence)
- [Annual Conference on Neural Information Processing Systems (NeurIPS'2019)](#Annual-Conference-on-Neural-Information-Processing-Systems)

## AAAI Conference on Artificial Intelligence

 - **Surveys without Questions: A Reinforcement Learning Approach.** [[pdf](https://doi.org/10.1609/aaai.v33i01.3301257)]
   - Atanu R. Sinha, Deepali Jain, Nikhil Sheoran, Sopan Khosla, Reshmi Sasidharan. *AAAI 2019*.
 - **Hierarchical Reinforcement Learning for Course Recommendation in MOOCs.** [[pdf](https://doi.org/10.1609/aaai.v33i01.3301435)]
   - Jing Zhang, Bowen Hao, Bo Chen, Cuiping Li, Hong Chen, Jimeng Sun. *AAAI 2019*.
 - **A Model-Free Affective Reinforcement Learning Approach to Personalization of an Autonomous Social Robot Companion for Early Literacy Education.** [[pdf](https://doi.org/10.1609/aaai.v33i01.3301687)]
   - Hae Won Park, Ishaan Grover, Samuel Spaulding, Louis Gomez, Cynthia Breazeal. *AAAI 2019*.
 - **VidyutVanika: A Reinforcement Learning Based Broker Agent for a Power Trading Competition.** [[pdf](https://doi.org/10.1609/aaai.v33i01.3301914)]
   - Susobhan Ghosh, Easwar Subramanian, Sanjay P. Bhat, Sujit Gujar, Praveen Paruchuri. *AAAI 2019*.
 - **Deep Reinforcement Learning for Syntactic Error Repair in Student Programs.** [[pdf](https://doi.org/10.1609/aaai.v33i01.3301930)]
   - Rahul Gupta, Aditya Kanade, Shirish K. Shevade. *AAAI 2019*.
 - **A Deep Reinforcement Learning Framework for Rebalancing Dockless Bike Sharing Systems.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33011393)]
   - Ling Pan, Qingpeng Cai, Zhixuan Fang, Pingzhong Tang, Longbo Huang. *AAAI 2019*.
 - **Deep Reinforcement Learning for Green Security Games with Real-Time Information.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33011401)]
   - Yufei Wang, Zheyuan Ryan Shi, Lantao Yu, Yi Wu, Rohit Singh, Lucas Joppa, Fei Fang. *AAAI 2019*.
 - **Improving Optimization Bounds Using Machine Learning: Decision Diagrams Meet Deep Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33011443)]
   - Quentin Cappart, Emmanuel Goutierre, David Bergman, Louis-Martin Rousseau. *AAAI 2019*.
 - **Generation of Policy-Level Explanations for Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33012514)]
   - Nicholay Topin, Manuela Veloso. *AAAI 2019*.
 - **Interactive Semantic Parsing for If-Then Recipes via Hierarchical Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33012547)]
   - Ziyu Yao, Xiujun Li, Jianfeng Gao, Brian M. Sadler, Huan Sun. *AAAI 2019*.
 - **SDRL: Interpretable and Data-Efficient Deep Reinforcement Learning Leveraging Symbolic Planning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33012970)]
   - Daoming Lyu, Fangkai Yang, Bo Liu, Steven Gustafson. *AAAI 2019*.
 - **End-to-End Safe Reinforcement Learning through Barrier Functions for Safety-Critical Continuous Control Tasks.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33013387)]
   - Richard Cheng, Gábor Orosz, Richard M. Murray, Joel W. Burdick. *AAAI 2019*.
 - **How to Combine Tree-Search Methods in Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33013494)]
   - Yonathan Efroni, Gal Dalal, Bruno Scherrer, Shie Mannor. *AAAI 2019*.
 - **Combined Reinforcement Learning via Abstract Representations.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33013582)]
   - Vincent François-Lavet, Yoshua Bengio, Doina Precup, Joelle Pineau. *AAAI 2019*.
 - **Fully Convolutional Network with Multi-Step Reinforcement Learning for Image Processing.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33013598)]
   - Ryosuke Furuta, Naoto Inoue, Toshihiko Yamasaki. *AAAI 2019*.
 - **Off-Policy Deep Reinforcement Learning by Bootstrapping the Covariate Shift.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33013647)]
   - Carles Gelada, Marc G. Bellemare. *AAAI 2019*.
 - **Hybrid Reinforcement Learning with Expert State Sequences.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33013739)]
   - Xiaoxiao Guo, Shiyu Chang, Mo Yu, Gerald Tesauro, Murray Campbell. *AAAI 2019*.
 - **Multi-Task Deep Reinforcement Learning with PopArt.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33013796)]
   - Matteo Hessel, Hubert Soyer, Lasse Espeholt, Wojciech Czarnecki, Simon Schmitt, Hado van Hasselt. *AAAI 2019*.
 - **Bootstrap Estimated Uncertainty of the Environment Model for Model-Based Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33013870)]
   - Wenzhen Huang, Junge Zhang, Kaiqi Huang. *AAAI 2019*.
 - **Classification with Costly Features Using Deep Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33013959)]
   - Jaromír Janisch, Tomás Pevný, Viliam Lisý. *AAAI 2019*.
 - **Robust Multi-Agent Reinforcement Learning via Minimax Deep Deterministic Policy Gradient.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33014213)]
   - Shihui Li, Yi Wu, Xinyue Cui, Honghua Dong, Fei Fang, Stuart Russell. *AAAI 2019*.
 - **The Utility of Sparse Representations for Control in Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33014384)]
   - Vincent Liu, Raksha Kumaraswamy, Lei Le, Martha White. *AAAI 2019*.
 - **A Comparative Analysis of Expected and Distributional Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33014504)]
   - Clare Lyle, Marc G. Bellemare, Pablo Samuel Castro. *AAAI 2019*.
 - **State-Augmentation Transformations for Risk-Sensitive Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33014512)]
   - Shuai Ma, Jia Yuan Yu. *AAAI 2019*.
 - **Determinantal Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33014659)]
   - Takayuki Osogami, Rudy Raymond. *AAAI 2019*.
 - **On Reinforcement Learning for Full-Length Game of StarCraft.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33014691)]
   - Zhen-Jia Pang, Ruo-Ze Liu, Zhou-Yu Meng, Yi Zhang, Yang Yu, Tong Lu. *AAAI 2019*.
 - **Virtual-Taobao: Virtualizing Real-World Online Retail Environment for Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33014902)]
   - Jing-Cheng Shi, Yang Yu, Qing Da, Shi-Yong Chen, Anxiang Zeng. *AAAI 2019*.
 - **Composable Modular Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33014975)]
   - Christopher L. Simpkins, Charles L. Isbell Jr.. *AAAI 2019*.
 - **Diversity-Driven Extensible Hierarchical Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33014992)]
   - Yuhang Song, Jianyi Wang, Thomas Lukasiewicz, Zhenghua Xu, Mai Xu. *AAAI 2019*.
 - **QUOTA: The Quantile Option Architecture for Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33015797)]
   - Shangtong Zhang, Hengshuai Yao. *AAAI 2019*.
 - **Message-Dropout: An Efficient Training Method for Multi-Agent Deep Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33016079)]
   - Woojun Kim, Myungsik Cho, Youngchul Sung. *AAAI 2019*.
 - **Learning to Teach in Cooperative Multiagent Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33016128)]
 ...
 - **Dialogue Generation: From Imitation Learning to Inverse Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33016722)]
   - Ziming Li, Julia Kiseleva, Maarten de Rijke. *AAAI 2019*.
 - **A Hierarchical Framework for Relation Extraction with Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33017072)]
   - Ryuichi Takanobu, Tianyang Zhang, Jiexi Liu, Minlie Huang. *AAAI 2019*.
 - **A Deep Reinforcement Learning Based Multi-Step Coarse to Fine Question Answering (MSCQA) System.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33017224)]
   - Yu Wang, Hongxia Jin. *AAAI 2019*.
 - **Machine Teaching for Inverse Reinforcement Learning: Algorithms and Applications.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33017749)]
   - Daniel S. Brown, Scott Niekum. *AAAI 2019*.
 - **Rethinking the Discount Factor in Reinforcement Learning: A Decision Theoretic Approach.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33017949)]
   - Silviu Pitis. *AAAI 2019*.
 - **Attention-Aware Sampling via Deep Reinforcement Learning for Action Recognition.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33018247)]
   - Wenkai Dong, Zhaoxiang Zhang, Tieniu Tan. *AAAI 2019*.
 - **Read, Watch, and Move: Reinforcement Learning for Temporally Grounding Natural Language Descriptions in Videos.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33018393)]
   - Dongliang He, Xiang Zhao, Jizhou Huang, Fu Li, Xiao Liu, Shilei Wen. *AAAI 2019*.
 - **Hierarchically Structured Reinforcement Learning for Topically Coherent Visual Story Generation.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33018465)]
   - Qiuyuan Huang, Zhe Gan, Asli Celikyilmaz, Dapeng Oliver Wu, Jianfeng Wang, Xiaodong He. *AAAI 2019*.
 - **A Theory of State Abstraction for Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33019876)]
   - David Abel. *AAAI 2019*.
 - **Reinforcement Learning for Improved Low Resource Dialogue Generation.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33019884)]
   - Ana Valeria González-Garduño. *AAAI 2019*.
 - **Verifiable and Interpretable Reinforcement Learning through Program Synthesis.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33019902)]
   - Abhinav Verma. *AAAI 2019*.
 - **Attention Guided Imitation Learning and Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33019906)]
   - Ruohan Zhang. *AAAI 2019*.
 - **Reinforcement Learning under Threats.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33019939)]
   - Víctor Gallego, Roi Naveiro, David Ríos Insua. *AAAI 2019*.
 - **Dynamic Vehicle Traffic Control Using Deep Reinforcement Learning in Automated Material Handling System.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33019949)]
   - Younkook Kang, Sungwon Lyu, Jeeyung Kim, Bongjoon Park, Sungzoon Cho. *AAAI 2019*.
 - **Deep Reinforcement Learning via Past-Success Directed Exploration.** [[pdf](https://doi.org/10.1609/aaai.v33i01.33019979)]
   - Xiaoming Liu, Zhixiong Xu, Lei Cao, Xiliang Chen, Kai Kang. *AAAI 2019*.
 - **Strategic Tasks for Explainable Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.330110007)]
   - Rey Pocius, Lawrence Neal, Alan Fern. *AAAI 2019*.
 - **Learning Representations in Model-Free Hierarchical Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.330110009)]
   - Jacob Rafati, David C. Noelle. *AAAI 2019*.
 - **Towards Sequence-to-Sequence Reinforcement Learning for Constraint Solving with Constraint-Based Local Search.** [[pdf](https://doi.org/10.1609/aaai.v33i01.330110037)]
   - Helge Spieker. *AAAI 2019*.
 - **MaMiC: Macro and Micro Curriculum for Robotic Reinforcement Learning.** [[pdf](https://doi.org/10.1609/aaai.v33i01.330110053)]
...
## International Joint Conference on Artificial Intelligence
 ...
 - **Value Function Transfer for Deep Multi-Agent Reinforcement Learning Based on N-Step Returns.** [[pdf](https://doi.org/10.24963/ijcai.2019/65)]
   - Yong Liu, Yujing Hu, Yang Gao, Yingfeng Chen, Changjie Fan. *IJCAI 2019*.
 - **Large-Scale Home Energy Management Using Entropy-Based Collective Multiagent Deep Reinforcement Learning Framework.** [[pdf](https://doi.org/10.24963/ijcai.2019/89)]
   - Yaodong Yang, Jianye Hao, Yan Zheng, Chao Yu. *IJCAI 2019*.
 - **Explaining Reinforcement Learning to Mere Mortals: An Empirical Study.** [[pdf](https://doi.org/10.24963/ijcai.2019/184)]
 ...
 - **An Actor-Critic-Attention Mechanism for Deep Reinforcement Learning in Multi-view Environments.** [[pdf](https://doi.org/10.24963/ijcai.2019/277)]
   - Elaheh Barati, Xuewen Chen. *IJCAI 2019*.
 - **A Restart-based Rank-1 Evolution Strategy for Reinforcement Learning.** [[pdf](https://doi.org/10.24963/ijcai.2019/295)]
   - Zefeng Chen, Yuren Zhou, Xiaoyu He, Siyu Jiang. *IJCAI 2019*.
 - **Hybrid Actor-Critic Reinforcement Learning in Parameterized Action Space.** [[pdf](https://doi.org/10.24963/ijcai.2019/316)]
   - Zhou Fan, Rui Su, Weinan Zhang, Yong Yu. *IJCAI 2019*.
 - **Deep Multi-Agent Reinforcement Learning with Discrete-Continuous Hybrid Action Spaces.** [[pdf](https://doi.org/10.24963/ijcai.2019/323)]
   - Haotian Fu, Hongyao Tang, Jianye Hao, Zihan Lei, Yingfeng Chen, Changjie Fan. *IJCAI 2019*.
 - **Automatic Successive Reinforcement Learning with Multiple Auxiliary Rewards.** [[pdf](https://doi.org/10.24963/ijcai.2019/324)]
   - Zhao-Yang Fu, De-Chuan Zhan, Xin-Chun Li, Yi-Xing Lu. *IJCAI 2019*.
 - **Reward Learning for Efficient Reinforcement Learning in Extractive Document Summarisation.** [[pdf](https://doi.org/10.24963/ijcai.2019/326)]
   - Yang Gao, Christian M. Meyer, Mohsen Mesgar, Iryna Gurevych. *IJCAI 2019*.
 - **Using Natural Language for Reward Shaping in Reinforcement Learning.** [[pdf](https://doi.org/10.24963/ijcai.2019/331)]
   - Prasoon Goyal, Scott Niekum, Raymond J. Mooney. *IJCAI 2019*.
 - **SlateQ: A Tractable Decomposition for Reinforcement Learning with Recommendation Sets.** [[pdf](https://doi.org/10.24963/ijcai.2019/360)]
 ...
 - **Interactive Teaching Algorithms for Inverse Reinforcement Learning.** [[pdf](https://doi.org/10.24963/ijcai.2019/374)]
   - Parameswaran Kamalaruban, Rati Devidze, Volkan Cevher, Adish Singla. *IJCAI 2019*.
 - **Autoregressive Policies for Continuous Control Deep Reinforcement Learning.** [[pdf](https://doi.org/10.24963/ijcai.2019/382)]
   - Dmytro Korenkevych, A. Rupam Mahmood, Gautham Vasan, James Bergstra. *IJCAI 2019*.
 - **Meta Reinforcement Learning with Task Embedding and Shared Policy.** [[pdf](https://doi.org/10.24963/ijcai.2019/387)]
   - Lin Lan, Zhenguo Li, Xiaohong Guan, Pinghui Wang. *IJCAI 2019*.
 - **Incremental Learning of Planning Actions in Model-Based Reinforcement Learning.** [[pdf](https://doi.org/10.24963/ijcai.2019/443)]
   - Jun Hao Alvin Ng, Ronald P. A. Petrick. *IJCAI 2019*.
 - **An Atari Model Zoo for Analyzing, Visualizing, and Comparing Deep Reinforcement Learning Agents.** [[pdf](https://doi.org/10.24963/ijcai.2019/452)]
 ...
 - **Successor Options: An Option Discovery Framework for Reinforcement Learning.** [[pdf](https://doi.org/10.24963/ijcai.2019/458)]
   - Rahul Ramesh, Manan Tomar, Balaraman Ravindran. *IJCAI 2019*.
 - **Soft Policy Gradient Method for Maximum Entropy Deep Reinforcement Learning.** [[pdf](https://doi.org/10.24963/ijcai.2019/475)]
   - Wenjie Shi, Shiji Song, Cheng Wu. *IJCAI 2019*.
 - **Solving Continual Combinatorial Selection via Deep Reinforcement Learning.** [[pdf](https://doi.org/10.24963/ijcai.2019/481)]
   - HyungSeok Song, Hyeryung Jang, Hai H. Tran, Se-eun Yoon, Kyunghwan Son, Donggyu Yun, Hyoju Chung, Yung Yi. *IJCAI 2019*.
 - **Playing FPS Games With Environment-Aware Hierarchical Reinforcement Learning.** [[pdf](https://doi.org/10.24963/ijcai.2019/482)]
   - Shihong Song, Jiayi Weng, Hang Su, Dong Yan, Haosheng Zou, Jun Zhu. *IJCAI 2019*.
 - **Sharing Experience in Multitask Reinforcement Learning.** [[pdf](https://doi.org/10.24963/ijcai.2019/505)]
 ...
 - **Interactive Reinforcement Learning with Dynamic Reuse of Prior Knowledge from Human and Agent Demonstrations.** [[pdf](https://doi.org/10.24963/ijcai.2019/530)]
   - Zhaodong Wang, Matthew E. Taylor. *IJCAI 2019*.
 - **Transfer of Temporal Logic Formulas in Reinforcement Learning.** [[pdf](https://doi.org/10.24963/ijcai.2019/557)]
   - Zhe Xu, Ufuk Topcu. *IJCAI 2019*.
 - **Metatrace Actor-Critic: Online Step-Size Tuning by Meta-gradient Descent for Reinforcement Learning Control.** [[pdf](https://doi.org/10.24963/ijcai.2019/581)]
   - Kenny Young, Baoxiang Wang, Matthew E. Taylor. *IJCAI 2019*.
 - **Reinforcement Learning Experience Reuse with Policy Residual Representation.** [[pdf](https://doi.org/10.24963/ijcai.2019/618)]
   - Wen-Ji Zhou, Yang Yu, Yingfeng Chen, Kai Guan, Tangjie Lv, Changjie Fan, Zhi-Hua Zhou. *IJCAI 2019*.
 - **Playing Card-Based RTS Games with Deep Reinforcement Learning.** [[pdf](https://doi.org/10.24963/ijcai.2019/631)]
   - Tianyu Liu, Zijie Zheng, Hongchang Li, Kaigui Bian, Lingyang Song. *IJCAI 2019*.
 - **Dynamic Electronic Toll Collection via Multi-Agent Deep Reinforcement Learning with Edge-Based Graph Convolutional Networks.** [[pdf](https://doi.org/10.24963/ijcai.2019/635)]
   - Wei Qiu, Haipeng Chen, Bo An. *IJCAI 2019*.
 - **A Dual Reinforcement Learning Framework for Unsupervised Text Style Transfer.** [[pdf](https://doi.org/10.24963/ijcai.2019/711)]
   - Fuli Luo, Peng Li, Jie Zhou, Pengcheng Yang, Baobao Chang, Xu Sun, Zhifang Sui. *IJCAI 2019*.
 - **Energy-Efficient Slithering Gait Exploration for a Snake-Like Robot Based on Reinforcement Learning.** [[pdf](https://doi.org/10.24963/ijcai.2019/785)]
   - Zhenshan Bing, Christian Lemke, Zhuangyi Jiang, Kai Huang, Alois C. Knoll. *IJCAI 2019*.
 - **Failure-Scenario Maker for Rule-Based Agent using Multi-agent Adversarial Reinforcement Learning and its Application to Autonomous Driving.** [[pdf](https://doi.org/10.24963/ijcai.2019/832)]
   - Akifumi Wachi. *IJCAI 2019*.
 - **LTL and Beyond: Formal Languages for Reward Function Specification in Reinforcement Learning.** [[pdf](https://doi.org/10.24963/ijcai.2019/840)]
   - Alberto Camacho, Rodrigo Toro Icarte, Toryn Q. Klassen, Richard Anthony Valenzano, Sheila A. McIlraith. *IJCAI 2019*.
 - **A Survey of Reinforcement Learning Informed by Natural Language.** [[pdf](https://doi.org/10.24963/ijcai.2019/880)]
 ...
 - **Leveraging Human Guidance for Deep Reinforcement Learning Tasks.** [[pdf](https://doi.org/10.24963/ijcai.2019/884)]
   - Ruohan Zhang, Faraz Torabi, Lin Guan, Dana H. Ballard, Peter Stone. *IJCAI 2019*.
 - **Teaching AI Agents Ethical Values Using Reinforcement Learning and Policy Orchestration.** [[pdf](https://doi.org/10.24963/ijcai.2019/891)]
 ...
 - **Can Meta-Interpretive Learning outperform Deep Reinforcement Learning of Evaluable Game strategies?.** [[pdf](https://doi.org/10.24963/ijcai.2019/909)]
   - Céline Hocquette. *IJCAI 2019*.
 - **Split Q Learning: Reinforcement Learning with Two-Stream Rewards.** [[pdf](https://doi.org/10.24963/ijcai.2019/913)]
   - Baihan Lin, Djallel Bouneffouf, Guillermo A. Cecchi. *IJCAI 2019*.
 - **Safe and Sample-Efficient Reinforcement Learning Algorithms for Factored Environments.** [[pdf](https://doi.org/10.24963/ijcai.2019/919)]
   - Thiago D. Simão. *IJCAI 2019*.
 - **CRSRL: Customer Routing System Using Reinforcement Learning.** [[pdf](https://doi.org/10.24963/ijcai.2019/952)]
   - Chong Long, Zining Liu, Xiaolu Lu, Zehong Hu, Yafang Wang. *IJCAI 2019*.
 - **Deep Reinforcement Learning for Ride-sharing Dispatching and Repositioning.** [[pdf](https://doi.org/10.24963/ijcai.2019/958)]
